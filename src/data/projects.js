...
Challenges included tuning algorithm thresholds, structuring and validating large datasets from the Yahoo Finance API, and ensuring clean separation of concerns between frontend, backend, and strategy logic.`,
  ...
  },
  {
    ...
    details: `This project was my introduction to modern web development. I used React.js + Vite with Tailwind CSS and Framer Motion for page transitions and animations. 
...
Major takeaways included learning layout systems, managing state, and deploying to Vercel.`,
  ...
  },
  {
    ...
    details: `This project was built in C++ and designed to parse schedules for multiple users from an input file, identify their individual free time slots, and compute overlapping availability to suggest meeting times. It supports working hour constraints, flexible meeting durations, and merges overlapping intervals to optimize results. 
...
I designed and coded the entire architecture, focusing on correctness of journal commit/rollback logic, safe memory handling, and clear separation between filesystem metadata (inodes) and data blocks.
...
I designed the lexer/parser by splitting on spaces and special characters, then implemented process control with Unix system calls (fork, execvp, wait).

Challenges included correctly wiring pipe file descriptors, handling edge cases in built-ins vs. external commands, and preserving command history for "!!".`,
